...
{
    UIImage *image = [[UIImage imageNamed:@"green_navbar_background"] resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 1.0, 0.0, 1.0)];
    return image;
}

-(UIImage *)backgroundImage
{
    return [UIImage imageNamed:@"green_background"];
}
